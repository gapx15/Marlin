...
#define DISABLE_INACTIVE_Z false // Disable if the nozzle could fall onto your printed part!
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       752           // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  301           // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT       912
    #define Y_CURRENT_HOME  376
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC PREHEAT_1_LABEL Z_CAL_DESC
  #define MAIN_MENU_ITEM_1_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_1_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND) Z_CAL_END
  #define MAIN_MENU_ITEM_1_CONFIRM

  #define MAIN_MENU_ITEM_2_DESC PREHEAT_2_LABEL Z_CAL_DESC
  #define MAIN_MENU_ITEM_2_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_2_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND) Z_CAL_END
  #define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC PREHEAT_3_LABEL Z_CAL_DESC
  #define MAIN_MENU_ITEM_3_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_3_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND) Z_CAL_END
  #define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC PREHEAT_4_LABEL Z_CAL_DESC
  #define MAIN_MENU_ITEM_4_GCODE Z_CAL_PRE_ABL STRINGIFY(PREHEAT_4_TEMP_BED) "\nM190 S" STRINGIFY(PREHEAT_4_TEMP_BED) "\nM104 S160\nM109 S160\nG29\nG1 X2.0 Y-2.0 Z0.60\nM104 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) "\nM109 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND) Z_CAL_END
  ...
  #define MAIN_MENU_ITEM_6_DESC "Full Calibration"
  #define MAIN_MENU_ITEM_6_GCODE "M140 S60\nM190 S60\nG28\nG34\nG29\nM500\nM140 S0\nG28"
  ...
  #define MAIN_MENU_ITEM_8_DESC "Auto Cold Pull"
  #define MAIN_MENU_ITEM_8_GCODE "G28\nM83\nG92 E0.00\nG21\nG1 X125 Y105 Z30\nM109 S250\nG1 E10.00 F6.5\nM109 S95\nM18 E\nM0 Pull your filament out\nM106 S0\nM109 S0"
  #define MAIN_MENU_ITEM_8_CONFIRM

  #define MAIN_MENU_ITEM_9_DESC "Reset EEPROM"
  #define MAIN_MENU_ITEM_9_GCODE "M502\nM500\nM117 EEPROM values restored\nG4 S3\nM0 Click to continue..."
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CONFIG_MENU_ITEM_1_DESC "Texture 1"       // Prusa Textured PEI Spring Steel Sheet
  #define CONFIG_MENU_ITEM_1_GCODE "M851 Z-1.17"
  #define CONFIG_MENU_ITEM_1_CONFIRM

  #define CONFIG_MENU_ITEM_2_DESC "Texture 2"       // Prusa Textured PEI Spring Steel Sheet
  #define CONFIG_MENU_ITEM_2_GCODE "M851 Z-1.17"
  #define CONFIG_MENU_ITEM_2_CONFIRM

  #define CONFIG_MENU_ITEM_3_DESC "Smooth"          // Prusa Smooth PEI Spring Steel Sheet
  #define CONFIG_MENU_ITEM_3_GCODE "M851 Z-0.08"
