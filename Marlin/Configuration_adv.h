 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       80      0        // (mA) RMS current. Multiply by 1.414 for peak current.
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_8_DESC "Firmware Updater" // Reboot controller to prepare for firmware update via SD card.
  #define MAIN_MENU_ITEM_8_GCODE "M997"
  ...
  #define MAIN_MENU_ITEM_10_DESC "Level X Gantry"
  #define MAIN_MENU_ITEM_10_GCODE "M117 " MAIN_MENU_ITEM_10_DESC "\nG34\nM0 " MAIN_MENU_ITEM_10_DESC " Complete"
