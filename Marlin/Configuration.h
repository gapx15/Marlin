...
#define STRING_CONFIG_H_AUTHOR "(gap, MK3S/BTT002/TMC2209/BMG)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gap's MK3Cs"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 15.68f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2099f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0550f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1582f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.17 }
